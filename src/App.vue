<template>
  <div class="home">
    <main>
      ...
      <ContactsPicker v-if="supportContactApi" />
      <p v-else>
    ...
    <footer>
      <a href="https://github.com/pierresaid/web-contact">
        <!-- prettier-ignore -->
        ...
        <span class="link-text">web-contact</span>
      </a>
    </footer>
  </div>
</template>
...
export default {
  ...
  data: () => ({
    supportContactApi: !!navigator.contacts
  })
};
</script>
